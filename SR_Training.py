# Speaker Recognition Training source code
...
source = r"F:\Speaker Recognition\SpeakerRecognition_Model1\Training_data\Speaker5"
# path to save trained model
destination = r"F:\Speaker Recognition\SpeakerRecognition_Model1\Trained_models"
