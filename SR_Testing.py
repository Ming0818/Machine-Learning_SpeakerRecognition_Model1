# Speaker Recognition Testing source code
...
sourcepath = r"F:\Speaker Recognition\SpeakerRecognition_Model1\Testing_data"

# path to saved models
modelpath = "F:\Speaker Recognition\SpeakerRecognition_Model1\Trained_models"
